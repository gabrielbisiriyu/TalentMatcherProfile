              ...
              <CardContent className="p-6">
                ...
                <div className="grid md:grid-cols-3 gap-4 mb-4">
                  ...
                  <div className="md:col-span-3">
                    <p className="text-sm font-medium text-gray-700 mb-2">Similarity Score</p>
                    <Progress value={match.combined_score } className="h-2" />
                    <p className="text-xs text-gray-600 mt-1">{(match.combined_score ).toFixed(1)}%</p>
                  </div>
